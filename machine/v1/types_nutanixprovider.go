...
type NutanixVMDisk struct {
	...
	// volumeGroup refers to a volume group for the VM disk
	// +optional
	VolumeGroup *configv1.NutanixResourceIdentifier `json:"volumeGroup,omitempty"`

	// dataSource refers to a data source for the VM disk
	// +optional
